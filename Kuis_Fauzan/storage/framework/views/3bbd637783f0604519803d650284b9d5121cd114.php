<?php $__env->startSection('title', 'Zanynn - About'); ?>
...
<!-- .page-title -->
<?php $__currentLoopData = $about; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<section class="about-text ptb-100">
    <section class="section-title">
        <div class="container text-center">
        
            <h2><?php echo e($zann->title); ?></h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-mt-6">
                <p><?php echo e($zann->description); ?></p>
            </div>
...
<section class="skills ptb-100 gray-bg">
    <section class="section-title">
        <div class="container text-center">
            <h2><?php echo e($zann->titlegraph); ?></h2>
            <span class="bordered-icon"><i class="fa fa-circle-thin"></i></span>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h3>Chart on year <?php echo e($zann->year); ?></h3>

                <p><?php echo e($zann->text); ?></p>
            </div>
            
            <div class="col-md-6 x-progress">
                <div class="progress-wrapper">
                    <div class="progress-item">
                        <span class="progress-title"><?php echo e($zann->year); ?></span>

                        <div class="progress">
                            <div class="progress-bar progress-bar-dealy" role="progressbar" aria-valuenow="<?php echo e($zann->valuebar); ?>"
                                 aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($zann->valuebar); ?>%;"></div>
                        </div>
                        <span class="progress-percent"><?php echo e($zann->valuebar); ?>%</span>
                    </div>
                    <!-- /.progress-item -->
...
<?php echo $__env->make('layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kuis\resources\views/About.blade.php ENDPATH**/ ?>