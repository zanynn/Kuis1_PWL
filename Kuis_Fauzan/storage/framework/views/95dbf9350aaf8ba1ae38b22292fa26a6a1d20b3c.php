<?php $__env->startSection('title', 'Zanynn - Home'); ?>
...
<section class="x-services ptb-100 gray-bg">
    ...
    <?php $__currentLoopData = $bodykit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="container">
        <div class="row">
            <div class="col-mt-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="<?php echo e($bk->imageurl); ?>" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#"><?php echo e($bk->title); ?></a></h3>

                        <p><?php echo e(Str::limit($bk->content, 100, '...')); ?></p>
                        <a href="<?php echo e('./article/'.$bk->id); ?>" class="btn btn-primary">Detail Product & Buy</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kuis\resources\views/Home.blade.php ENDPATH**/ ?>